...
def get_db_connection(database="LF_LMS_Logs"):
...
def fetch_model_request_from_db(ibv_status_id, date_created=None):
    """
    Fetch ModelRequest JSON from LF_LMS_Logs..CModelLogs database.
    ...
    try:
        ...
        # Connect to LF_LMS_Logs database
        db_conn = get_db_connection(database="LF_LMS_Logs")
...
def insert_result_to_db(
    ...
    try:
        ...
        insert_query = text("""
        INSERT INTO [BankuityPostOnboarding].[dbo].[SpeedyAnalysis] 
